                                ...
                                <div class="container" style="width: 80vw !important">
                                    ...
                                    <div class="bg-light p-4 mt-5 rounded">
                                                    ...
                                                    <div class="d-flex">
                                                        <% String sortBy=(String)request.getParameter("sortBy"); %>
                                                            <select id="select" name="sortBy">
                                                                <option value="" <% if (sortBy==null ||
                                                                    sortBy.isEmpty()) { out.print("selected"); }%>>Sắp
                                                                    xếp</option>
                                                                <option value="name" <% if (sortBy !=null &&
                                                                    sortBy.equals("name")) { out.print("selected"); }%>
                                                                    >Tên bài viết</option>
                                                                <option value="view" <% if (sortBy !=null &&
                                                                    sortBy.equals("view")) { out.print("selected"); }%>
                                                                    >Lượt xem</option>
                                                            </select>
                                                            <% String state=(String)request.getParameter("state"); %>
                                                                <select id="select" class="ms-3" name="state">
                                                                    <option value="-1" <% if (state==null ||
                                                                        state.isEmpty()) { out.print("selected"); }%>
                                                                        >Trạng thái</option>
                                                                    <option value="0" <% if (state !=null &&
                                                                        state.equals("0")) { out.print("selected"); }%>
                                                                        >Đang chờ duyệt</option>
                                                                    <option value="1" <% if (state !=null &&
                                                                        state.equals("1")) { out.print("selected"); } %>
                                                                        >Đang phát hành</option>
                                                                    <option value="2" <% if (state !=null &&
                                                                        state.equals("2")) { out.print("selected"); } %>
                                                                        >Đã cấm</option>
                                                                </select>
                                                    </div>
                                                        ...
                                                        for (int i = 0;i < posts.size();i++) { %>
                                                            <tr>
                                                                ...
                                                                <td class="d-flex justify-content-between">
                                                                    ...
                                                                    <a href=""
                                                                        class="text-decoration-none main-color">Xóa</a>
                                                                </td>
                                                            </tr>
                                                            <% } %>
                                            </tbody>
                                        ...
                                        <nav class="d-flex justify-content-center">
                                            <ul class="pagination">
                                                <li class="page-item"><a class="page-link main-color"
                                                        href="#">Previous</a></li>
